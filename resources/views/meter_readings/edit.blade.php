...
<head>
    ...
    <title>แก้ไขข้อมูลมิเตอร์ - ระบบบริหารจัดการหอพัก</title>
...
<div class="container">
    ...
    <div class="card">
        ...
        <form
            action="{{ route('meter-readings.update', $meterReading->id) }}"
            method="POST"
        >
                ...
                <select name="tenant_id" id="tenant_id" required>
                    ...
                    @foreach ($tenants as $tenant)
                        ...
                        <option
                            ...
                            {{ old('tenant_id', $meterReading->tenant_id) == $tenant->id ? 'selected' : '' }}
                        >
            ...
            <div class="form-group">
                ...
                <select name="room_id" id="room_id" required>
                    ...
                    @foreach ($rooms as $room)
                        ...
                        <option
                            value="{{ $room->id }}"
                            {{ old('room_id', $meterReading->room_id) == $room->id ? 'selected' : '' }}
                        >
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    name="billing_month"
                    id="billing_month"
                    value="{{ old('billing_month', $meterReading->billing_month) }}"
                    required
                >
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        name="water_previous"
                        id="water_previous"
                        value="{{ old('water_previous', $meterReading->water_previous) }}"
                        min="0"
                        step="0.01"
                        required
                    >
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        name="water_current"
                        id="water_current"
                        value="{{ old('water_current', $meterReading->water_current) }}"
                        min="0"
                        step="0.01"
                        required
                    >
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        name="water_rate"
                        id="water_rate"
                        value="{{ old('water_rate', $meterReading->water_rate) }}"
                        min="0"
                        step="0.01"
                        required
                    >
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        value="{{ old('electricity_previous', $meterReading->electricity_previous) }}"
                        min="0"
                        step="0.01"
                        required
                    >
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        value="{{ old('electricity_current', $meterReading->electricity_current) }}"
                        min="0"
                        step="0.01"
                        required
                    >
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        id="electricity_rate"
                        value="{{ old('electricity_rate', $meterReading->electricity_rate) }}"
                        min="0"
                        step="0.01"
                        required
                    >
            ...
            <div class="form-group">
                ...
                >{{ old('description', $meterReading->description) }}</textarea>
